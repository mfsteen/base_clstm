...
from keras.layers import LSTM, Masking, Bidirectional, Dropout, MaxPooling1D, Conv1D
...
model.add(Conv1D(input_shape=(1500, num_amino_acids), filters=320, kernel_size=26, padding="valid", activation="relu"))
